...
export const metadata: Metadata = {
  title: "Política de Cookies | Rafael Menezes Odontologia",
  description: "Informações sobre cookies e recursos de terceiros no site demonstrativo da Rafael Menezes Odontologia.",
};
...
export default function Cookies() {
  return <main className="legal-page">
    ...
    <p className="updated">Última atualização: 30 de julho de 2026.</p>
    <section>
      ...
      <h2>Serviços externos</h2><p>Links externos são abertos somente depois de uma ação do visitante. A partir desse momento, o serviço poderá aplicar suas próprias tecnologias e políticas.</p>
